...
A requisição deve passar por um *filter* para que não seja necessário criar um try/catch em cada método de requisição. 
...
No Spring podemos usar anotações para facilitar essa implementação de filter:

```java title:"SecurityFilter.java"
@Component
public class SecurityFilter extends OncePerRequestFilter {
    ...
    throws ServletException, IOException {
		...
		// chama os próximos filtros na aplicação
